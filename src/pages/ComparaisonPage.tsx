...
export default function ComparaisonPage() {
    ...
    // Si les scénarios sont vides, afficher un message
    if (scenarioT0.isEmpty || scenarioPrev.isEmpty) {
        return (
            <Layout fullHeight>
                <div className="flex items-center justify-center h-full p-6">
                    <div className="text-center">
                        ...
                        <h3 className="text-xl font-semibold text-gray-700 mb-2">Comparaison impossible</h3>
                        <p className="text-gray-500 mb-6">
                            {scenarioT0.isEmpty && scenarioPrev.isEmpty 
                                ? "Les deux scénarios sont vides. Veuillez importer les données."
                                : scenarioT0.isEmpty 
                                    ? "Le scénario T0 est vide. Veuillez importer les données."
                                    : "Le scénario prévisionnel est vide. Veuillez importer les données."
                            }
                        </p>
                        <div className="flex space-x-4 justify-center">
                            ...
                            >
                                Aller au Scénario T0
                            </Link>
                            <Link
                                to={`/exploitation/${id}/scenario/previsionnel`}
                                className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium"
                            >
                                Aller au Scénario Prévisionnel
                            </Link>
                        </div>
                    </div>
                </div>
            ...
            <div className="flex flex-col h-full p-6">
                ...
                <div className="flex justify-center space-x-4 mt-6">
                    <Link
                        ...
                        className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium"
                    >
                        Modifier Scénario T0
                    </Link>
                    <Link
                        to={`/exploitation/${id}/scenario/previsionnel`}
                        className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium"
                    >
                        Modifier Scénario Prévisionnel
                    </Link>
                </div>
            </div>
        </Layout>
