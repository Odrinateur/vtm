        ...
        >
                ...
                <div className="flex items-center justify-between mb-4">
                    <div>
                        ...
                        <p className="text-sm text-gray-600">
                            Données climatiques de référence pour les calculs
                            SIMEOS
                        </p>
                    </div>
            ...
            <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
                ...
                <div className="text-blue-800 text-sm space-y-2">
                    <p>
                        <strong>ETP (Évapotranspiration Potentielle) :</strong>{" "}
                        Quantité d'eau évapotranspirée par une culture de
                        référence dans des conditions optimales.
                    </p>
                    <p>
                        <strong>Précipitations :</strong> Cumul annuel moyen des
                        précipitations pour la zone climatique.
                    </p>
                    <p>
